...
class MainTab(QWidget):
    ...
    def FirstTabInitUi(self):
        ...
        self.CommgroupBoxwidth = 430
        self.CommgroupBoxheight = 100
        ...
        self.ConDisButton.move(10 + 100 + 100+50+60, 65)
        ...
        self.progressbar.setFixedWidth(50*6)


        self.ValuesgroupBox = QGroupBox("Temperature & Pressure Readings",self)
        self.ValuesgroupBox.setGeometry(QRect(self.ValuesgroupBoxxpos, self.ValuesgroupBoxypos, self.ValuesgroupBoxwidth+63, self.ValuesgroupBoxheight+120))
    ...
    def Temp1Display(self):
        ...
        self.Temp1groupBox.setGeometry(
            QRect(self.ValuesgroupBoxxpos+10, self.ValuesgroupBoxypos+20, self.ValuesgroupBoxwidth-160,
                  self.ValuesgroupBoxheight-120))
        ...
        self.widgetTemp1 = AnalogGaugeWidget(self.Temp1groupBox)
        self.widgetTemp1.setMinimumSize(QSize(180, 180))
        self.widgetTemp1.setMaximumSize(QSize(500, 500))
        self.widgetTemp1.setBaseSize(QSize(300,300))
        self.widgetTemp1.move(20,55)
        self.widgetTemp1.value_max = 100
...
#self.Temp1NLV.setText(str(float(self.Temp1LimitsA[0]) / 10))
        ...
        self.widgetTemp1.normallmtcolor = 0
        self.widgetTemp1.warnlmtcolor = 0
        self.widgetTemp1.actionlmtcolor = 0
        self.widgetTemp1.gauge_color_inner_radius_factor = 0.90
    ...
    def Temp2Display(self):
        ...
        self.Temp2groupBox.setGeometry(
            QRect(self.ValuesgroupBoxxpos+220, self.ValuesgroupBoxypos+20, self.ValuesgroupBoxwidth-160,
                  self.ValuesgroupBoxheight-120))
        ...
        self.widgetTemp2 = AnalogGaugeWidget(self.Temp2groupBox)
        self.widgetTemp2.setMinimumSize(QSize(180, 180))
        self.widgetTemp2.setMaximumSize(QSize(500, 500))
        self.widgetTemp2.setBaseSize(QSize(300,300))
        self.widgetTemp2.move(20,55)
        self.widgetTemp2.value_max = 100


        self.widgetTemp2.normallmtcolor = 0
        self.widgetTemp2.warnlmtcolor = 0
        self.widgetTemp2.actionlmtcolor = 0
        self.widgetTemp2.gauge_color_inner_radius_factor = 0.90
    ...
    def Press1Display(self):
        ...
        self.Pres1groupBox.setGeometry(
            QRect(self.ValuesgroupBoxxpos+10, self.ValuesgroupBoxypos+240, self.ValuesgroupBoxwidth-160,
                  self.ValuesgroupBoxheight-120))
        ...
        self.widgetPress1 = AnalogGaugeWidget(self.Pres1groupBox)
        self.widgetPress1.setMinimumSize(QSize(180, 180))
        self.widgetPress1.setMaximumSize(QSize(500, 500))
        self.widgetPress1.setBaseSize(QSize(300,300))
        self.widgetPress1.move(20,55)
        self.widgetPress1.value_max = 100


        self.widgetPress1.normallmtcolor = 0
        self.widgetPress1.warnlmtcolor = 0
        self.widgetPress1.actionlmtcolor = 0
        self.widgetPress1.gauge_color_inner_radius_factor = 0.90
    ...
    def Press2Display(self):
        ...
        self.Pres2groupBox.setGeometry(
            QRect(self.ValuesgroupBoxxpos+220, self.ValuesgroupBoxypos+240, self.ValuesgroupBoxwidth-160,
                  self.ValuesgroupBoxheight-120))
        ...
        self.widgetPress2 = AnalogGaugeWidget(self.Pres2groupBox)
        self.widgetPress2.setMinimumSize(QSize(180, 180))
        self.widgetPress2.setMaximumSize(QSize(500, 500))
        self.widgetPress2.setBaseSize(QSize(300,300))
        self.widgetPress2.move(20,55)
        self.widgetPress2.value_max = 100


        self.widgetPress2.normallmtcolor = 0
        self.widgetPress2.warnlmtcolor = 0
        self.widgetPress2.actionlmtcolor = 0
        self.widgetPress2.gauge_color_inner_radius_factor = 0.90
    ...
    def StatusRecieved(self):
        ...
        self.Status_RecievedBox.setGeometry(QRect(20, 600, 520, 150))
        ...
        self.Command_SentBox.setGeometry(QRect(550, 600, 375, 150))
        ...
        try:
            ...
            while (self.chosenport != 0):
                ...
                if self.Temp1GetLmtsFlag == 1:
                    ...
                    self.widgetTemp1.normallmtcolor = 1-(float(self.Temp1LimitsA[0]) / 1000)
                    self.widgetTemp1.warnlmtcolor = 1-(float(self.Temp1LimitsA[1]) / 1000)
                    self.widgetTemp1.actionlmtcolor = 1-(float(self.Temp1LimitsA[2]) / 1000)
                    ...
                    self.widgetTemp2.normallmtcolor = 1-(float(self.Temp2LimitsA[0]) / 1000)
                    self.widgetTemp2.warnlmtcolor = 1-(float(self.Temp2LimitsA[1]) / 1000)
                    self.widgetTemp2.actionlmtcolor = 1-(float(self.Temp2LimitsA[2]) / 1000)
                    ...
                    self.widgetPress1.normallmtcolor = 1-(float(self.Press1LimitsA[0]) / 1000)
                    self.widgetPress1.warnlmtcolor = 1-(float(self.Press1LimitsA[1]) / 1000)
                    self.widgetPress1.actionlmtcolor = 1-(float(self.Press1LimitsA[2]) / 1000)
                    ...
                    self.widgetPress2.normallmtcolor = 1-(float(self.Press2LimitsA[0]) / 1000)
                    self.widgetPress2.warnlmtcolor = 1-(float(self.Press2LimitsA[1]) / 1000)
                    self.widgetPress2.actionlmtcolor = 1-(float(self.Press2LimitsA[2]) / 1000)
    ...
    def UpdateLCD (self):
       try:
        ...
        self.widgetTemp1.update_value(float(self.Temp1Value))

        self.Temp2Value = (float(self.ArduinoData1[1])) / 10
        #self.Gauge2Value.setText(str(self.Temp2Value))
        self.widgetTemp2.update_value(float(self.Temp2Value))




        self.Press1Value = (float(self.ArduinoData1[2]))/10
        self.widgetPress1.update_value(float(self.Press1Value))
        ...
        self.widgetPress2.update_value(float(self.Press2Value))
